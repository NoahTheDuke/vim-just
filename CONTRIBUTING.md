...
Please do not use any generative AI when commenting in this project in any form -
not when filing an issue, not when writing a pull request description, not when writing a comment, not when writing a commit message, etc.

These means of communication exist primarily for humans to connect about this project.
If we want to talk to an AI,
then as with our code contribution policy,
we would directly use an AI chat platform ourselves on our own terms.

Don't worry about 100% perfect writing.  Participation in `vim-just` is a shared learning experience!
