...
syn keyword justRecipeAttr
   \ confirm doc exit-message extension group linux macos metadata no-cd no-exit-message no-quiet openbsd positional-arguments private script unix windows working-directory
   \ contained
